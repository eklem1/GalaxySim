...
print("Using {0} walkers, {1} burn in, {2} steps, z limit {3}.".format(NumWalkers, BurnIn, StepCount, zLim) )

# Independent variables
redshiftTotal = np.sort(np.array([0.35, 0.875, 1.125, 1.75, 2.25, 2.75, 1.65, 2.5, 3.5, 0.10165, 0.25, 0.45, 0.575, 0.725, 0.9]))

mask = [i <= zLim for i in redshiftTotal]
...
dt_string = datetime.now().strftime("%d_%m_%H-%M") + "_" + str( zLim)
